# Generated by Django 4.2 on 2025-12-23 09:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='relationbase_set', to='tests.nonsymrelationbase')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tests.parentmodel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='AltChildModel',
            fields=[
                ('parentmodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tests.parentmodel')),
                ('other_name', models.CharField(max_length=10)),
                ('link_on_altchild', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='tests.plaina')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nonsymrelationbase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tests.nonsymrelationbase')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plainobj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tests.plainmodel')),
            ],
        ),
        migrations.CreateModel(
            name='RecursionBug',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('altchildmodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tests.altchildmodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('parentmodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='tests.parentmodel')),
                ('other_name', models.CharField(max_length=10)),
                ('link_on_child', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='tests.modelextraexternal')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
